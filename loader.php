...
// Loader Usage:
// =============
// 1. replace all occurrences of bugbot_ in this file with the plugin namespace prefix eg. my_plugin_
...
// $instance = new bugbot_loader($args);					// instantiates loader class
// (ie. search and replace 'bugbot_' with 'my_plugin_')
...
add_action('plugins_loaded', 'bugbot_load_prefixed_functions', 0);

function bugbot_load_prefixed_functions() {
	...
	if (!function_exists('bugbot_loader_instance')) {
		function bugbot_loader_instance() {
	...
	// Add Settings
	// ------------
	if (!function_exists('bugbot_add_settings')) {
	 function bugbot_add_settings() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
	...
	// Get Defaults
	// ------------
	if (!function_exists('bugbot_default_settings')) {
	 function bugbot_default_settings($key=false) {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Get Options
	// -----------
	if (!function_exists('bugbot_get_options')) {
	 function bugbot_get_options() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Get Setting
	// -----------
	if (!function_exists('bugbot_get_setting')) {
	 function bugbot_get_setting($key, $filter=true) {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Reset Settings
	// --------------
	if (!function_exists('bugbot_reset_settings')) {
	 function bugbot_reset_settings() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Update Settings
	// ---------------
	if (!function_exists('bugbot_update_settings')) {
	 function bugbot_update_settings() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Delete Settings
	// ---------------
	if (!function_exists('bugbot_delete_settings')) {
	 function bugbot_delete_settings() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Set Pro Namespace
	// -----------------
	if (!function_exists('bugbot_pro_namespace')) {
	 function bugbot_pro_namespace($pronamespace) {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Settings Header
	// ---------------
	if (!function_exists('bugbot_settings_header')) {
	 function bugbot_settings_header() {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
	...
	// Settings Page
	// -------------
	if (!function_exists('bugbot_settings_page')) {
	...
	// Message Box
	// -----------
	if (!function_exists('bugbot_message_box')) {
	 function bugbot_message_box($message, $echo=false) {
		$f = __FUNCTION__; $namespace = substr($f,0,strrpos($f,'_',(strrpos($f,'_')-strlen($f)-1)));
		$instance = $GLOBALS[$namespace.'_instance'];
